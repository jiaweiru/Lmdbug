...
def main(
    ...
    protobuf_module: str = typer.Option(None, "--protobuf-module", "-p", help="Path to compiled protobuf module (.py file)"),
    message_class: str = typer.Option(None, "--message-class", "-m", help="Protobuf message class name"),
    ...
    log_level: LogLevel = typer.Option(LogLevel.INFO, "--log-level", help="Logging level"),
    ...
    try:
        ...
        if db_path:
            ...
            typer.echo("⚠ No database path specified. You can set it through the web interface.")
