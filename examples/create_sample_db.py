...
def create_sample_database(db_path: str):
    ...
    try:
        ...
        with lmdb.open(db_path, map_size=50 * 1024 * 1024) as env:  # 50MB for audio data
            with env.begin(write=True) as txn:
                ...
                users_data = [
                    {
                        ...
                        "voice_audio": generate_fake_pcm_audio(1500),  # 1.5 second audio
                    },
                    {
                        "id": 2, 
                    ...
                    },
                    {
                        ...
                        "voice_audio": generate_fake_pcm_audio(1200),  # 1.2 second audio
                    },
                ]
                ...
                for user_data in users_data:
                    ...
                    user.description = user_data["description"]  # Text for text processor
                    user.voice_audio = user_data["voice_audio"]    # Audio for audio processor
                    ...
                    user.profile.bio = user_data["description"][:100] + "..." # Short bio
                ...
                for i in range(15):
                    ...
                    value = f"Test item #{i} - created for Lmdbug demonstration".encode()
                    txn.put(key, value)
                
                print(f"✓ Created sample LMDB database at: {db_path}")
                print(f"✓ Added {txn.stat()['entries']} entries")
                print(f"✓ Generated {len(users_data)} User protobuf messages with audio and text data")
