...
custom field processors, similar to the Cream project design.
"""
...
class ProcessorRegistry:
    ...
    def register_decorator(self, name: str):
        ...
        """
        def decorator(processor_class: type[BaseFieldProcessor]) -> type[BaseFieldProcessor]:
            self.register(name, processor_class)
            return processor_class
        return decorator

    def create_processor(self, name: str, config: dict | None = None) -> BaseFieldProcessor:
